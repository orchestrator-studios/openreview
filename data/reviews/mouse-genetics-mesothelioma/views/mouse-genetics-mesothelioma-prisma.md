# PRISMA account — Genetic mutations and susceptibility to asbestos-induced mesothelioma in mice

_Generated from data by `tools/build_views.py` — do not edit by hand._

## Search
- **PubMed** (2026-07-07): 251 hits — `(mesothelioma) AND (asbestos OR crocidolite OR amosite OR chrysotile OR "mineral fiber" OR "mineral fibre" OR erionite) AND (mice OR mouse OR murine) AND (knockout OR "knock-out" OR transgenic OR heterozygous OR deficient OR "deficient mice" OR mutant OR mutation OR genetic OR genetically OR conditional OR "gene deletion" OR haploinsufficient)`
- **PubMed** (2026-07-07): 79 hits — `(mesothelioma) AND (asbestos OR crocidolite OR amosite OR chrysotile OR erionite) AND (mice OR mouse OR murine) AND (Nf2 OR Cdkn2a OR "p16INK4a" OR Ink4a OR Arf OR Trp53 OR Tp53 OR Bap1 OR Nlrp3 OR Lats2 OR Tsc1 OR "beta-catenin" OR Wt1 OR Nf2/Cdkn2a)`
- **PubMed** (2026-07-07): 202 hits — `(mesothelioma) AND (asbestos OR crocidolite OR amosite OR chrysotile OR erionite) AND (mice OR mouse OR murine) AND (susceptibility OR susceptible OR predisposition OR tumor suppressor OR "tumour suppressor" OR carcinogenesis OR knockout OR null OR "-/-")`
...
## Included studies
- Fisher et al. 2024 — The MexTAg collaborative cross: host genetics affects asbestos related disease latency, but has little influence once tumours develop. (PMID 38694815)
...
- Fleury-Feith et al. 2003 — Hemizygosity of Nf2 is associated with increased susceptibility to asbestos-induced peritoneal tumours. (PMID 12802287)
- Vaslet et al. 2002 — Accelerated progression of asbestos-induced mesotheliomas in heterozygous p53+/- mice. (PMID 12151629)
- Marsella et al. 1997 — Susceptibility of p53-deficient mice to induction of mesothelioma by crocidolite asbestos fibers. (PMID 9400702)
